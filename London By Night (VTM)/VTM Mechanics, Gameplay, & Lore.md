...
- **Difficulty**: how many successes are needed to accomplish an action, with 7 or more successes being nearly impossible (see [[table-id-BQx3Hx]] for examples)
...
- **Social Attributes**:
	- Charisma: [[table-id-DxCmbc]]
	- Manipulation: [[table-id-KkKzk0]]
	- Composure: